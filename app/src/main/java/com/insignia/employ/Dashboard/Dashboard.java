...
public class Dashboard extends AppCompatActivity implements DrawerAdapter.OnItemSelectedListener {
    ...
    public static final String CHANNEL_ID="SensorProject";
    public static final String CHANNEL_NAME="Sensor Project";
    public static final String CHANNEL_DESC="Sensor Project Notification";
